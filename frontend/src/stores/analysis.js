...
export const useAnalysisStore = defineStore('analysis', () => {
    ...
    const aggregateStats = computed(() => {
        ...
        const computeFinals = (metrics) => {
            ...
            result.win_pct = (list.length > 0 ? (wins / list.length * 100) : 0) // Always global average
            result.game_win_pct = getPct('game_win_pct', null, null)
            result.set_win_pct = getPct('set_win_pct', null, null)
