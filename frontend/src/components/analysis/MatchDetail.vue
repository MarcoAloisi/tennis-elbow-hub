...
import { ClipboardList, BarChart, ArrowLeft, Trophy, Clock, Calendar } from 'lucide-vue-next'
...
<template>
  <div class="match-detail-view">
    ...
    <div class="match-info-card">
      ...
      <div class="match-info-content">
        ...
        <div class="match-meta">
          <span v-if="store.matchInfo?.tournament" class="icon-text">
            <Trophy :size="14" class="text-accent" /> {{ store.matchInfo.tournament }}
          </span>
          <span v-if="store.matchInfo?.duration" class="icon-text">
            <Clock :size="14" class="text-accent" /> {{ store.matchInfo.duration }}
          </span>
          <span v-if="store.matchInfo?.date" class="icon-text">
            <Calendar :size="14" class="text-accent" /> {{ formatDate(store.matchInfo.date) }}
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="analysis-tabs">
      ...
      >
        <span class="icon-text"><ClipboardList :size="16" /> Statistics</span>
      </button>
      <button 
        class="tab-btn"
      ...
      >
        <span class="icon-text"><BarChart :size="16" /> Charts</span>
      </button>
    </div>
