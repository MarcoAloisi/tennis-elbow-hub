...
const statCategories = {
  serve: [
    { key: 'first_serve_pct', label: '1st Serve %', format: 'pct', path: 'serve' },
    { key: 'aces', label: 'Aces', format: 'num', path: 'serve' },
    { key: 'double_faults', label: 'Double Faults', format: 'num', path: 'serve', lower: true },
    { key: 'fastest_serve_kmh', label: 'Fastest Serve', format: 'speed', path: 'serve' },
    { key: 'avg_first_serve_kmh', label: 'Avg 1st Serve', format: 'speed', path: 'serve' },
    { key: 'avg_second_serve_kmh', label: 'Avg 2nd Serve', format: 'speed', path: 'serve' }
  ],
  rally: [
    { key: 'short_rallies_won', label: 'Short Rallies Won', format: 'ratio', path: 'rally', total: 'short_rallies_total' },
    { key: 'normal_rallies_won', label: 'Medium Rallies Won', format: 'ratio', path: 'rally', total: 'normal_rallies_total' },
    { key: 'long_rallies_won', label: 'Long Rallies Won', format: 'ratio', path: 'rally', total: 'long_rallies_total' }
  ],
  points: [
    { key: 'winners', label: 'Winners', format: 'num', path: 'points' },
    { key: 'forced_errors', label: 'Forced Errors', format: 'num', path: 'points' },
    { key: 'unforced_errors', label: 'Unforced Errors', format: 'num', path: 'points', lower: true },
    { key: 'net_points_won', label: 'Net Points Won', format: 'ratio', path: 'points', total: 'net_points_total' },
    { key: 'total_points_won', label: 'Total Points Won', format: 'num', path: 'points' }
  ],
  break_points: [
    { key: 'break_points_won', label: 'Break Points Won', format: 'ratio', path: 'break_points', total: 'break_points_total' },
    { key: 'break_games_won', label: 'Games Broken', format: 'num', path: 'break_points' },
